...
namespace StoreScrapper.Data.Migrations
{
    ...
    [Migration("20260126211647_JobExecutionManyTable")]
    partial class JobExecutionManyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobExecutionLogProductSku", b =>
                {
                    b.Property<int>("JobExecutionLogsId")
                        .HasColumnType("integer")
                        .HasColumnName("job_execution_logs_id");

                    b.Property<int>("ProductSkusId")
                        .HasColumnType("integer")
                        .HasColumnName("product_skus_id");

                    b.HasKey("JobExecutionLogsId", "ProductSkusId")
                        .HasName("pk_job_execution_log_product_sku");

                    b.HasIndex("ProductSkusId")
                        .HasDatabaseName("ix_job_execution_log_product_sku_product_skus_id");

                    b.ToTable("job_execution_log_product_sku", (string)null);
                });
            ...
            modelBuilder.Entity("JobExecutionLogProductSku", b =>
                {
                    b.HasOne("StoreScrapper.Models.Entities.JobExecutionLog", null)
                        .WithMany()
                        .HasForeignKey("JobExecutionLogsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_execution_log_product_sku_job_execution_logs_job_execut");
                    ...
                    b.HasOne("StoreScrapper.Models.Entities.ProductSku", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_execution_log_product_sku_product_skus_product_skus_id");
                });
